                ...
                {tasksTodo.map((task, index) => {
                  return (
                    ...
                    >
                      ...
                      <button className="flex-no-shrink ml-1 mr-1 border-2 rounded hover:text-white hover:bg-slate-800 text-green border-green hover:bg-green">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                      ...
                      <button className="flex-no-shrink  border-2 rounded text-red border-red hover:text-white hover:bg-slate-800 hover:bg-red">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
